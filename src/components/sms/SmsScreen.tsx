...
export function SmsScreen() {
  ...
  const [campaigns, setCampaigns] = React.useState<SmsCampaign[]>(initialSmsCampaigns)
  const [templates] = React.useState<SmsTemplate[]>(initialSmsTemplates)
  const [isNewModalOpen, setIsNewModalOpen] = React.useState(false)

  const handleAddCampaign = (newCampaign: SmsCampaign) => {
