    ...
    >
      <div className="container mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8">
          <a href="#home" className="text-sm font-medium text-muted-foreground hover:text-[#2563EB] transition-colors">
            Home
          </a>
          <a href="#products" className="text-sm font-medium text-muted-foreground hover:text-[#2563EB] transition-colors">
            Products
          </a>
          <a href="#pricing" className="text-sm font-medium text-muted-foreground hover:text-[#2563EB] transition-colors">
            Pricing
          </a>
          <a href="#about" className="text-sm font-medium text-muted-foreground hover:text-[#2563EB] transition-colors">
            About Us
          </a>
        </nav>
